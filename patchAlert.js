...
c = c.replace('const [isError, setIsError] = useState(false);', 'const [isError, setIsError] = useState(false);\n  const [showExitPrompt, setShowExitPrompt] = useState(false);');
...
const exitOverlayStr = `
      ...
      {/* Absolute Bottom of DOM hierarchy
`;

c = c.replace('{/* Absolute Bottom of DOM hierarchy', exitOverlayStr);
