...
export const COLLECTION_SECTIONS: MuniCollectionSection[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "leaf-poncho", label: "Leaf Poncho", price: 130, source: require("../assets/images/Muni Customization/Outfit/leaf-poncho.webp") },
      { id: "night-cape", label: "Night Cape", price: 140, source: require("../assets/images/Muni Customization/Outfit/night-cape.webp") },
      ...
      { id: "star-cloak", label: "Star Cloak", price: 150, source: require("../assets/images/Muni Customization/Outfit/star-cloak.webp") },
